...
MAX_DISTANCE_FROM_OWNER = 5
MIN_DISTANCE_FROM_OWNER = 2
MAX_DISTANCE = 20

RAIO_PATRULHA = MAX_DISTANCE_FROM_OWNER * 2-- Distância máxima em células que o Homunculus andará do mestre.
TEMPO_ESPERA_MIN = 2500 -- Tempo mínimo em milissegundos para esperar antes de um novo movimento.
TEMPO_ESPERA_MAX = 5500 -- Tempo máximo em milissegundos para esperar antes de um novo movimento.